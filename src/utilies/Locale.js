const rthkArchive = {'tc':'香港電台節目重溫', 'sc':'香港电台节目重温', 'en':'RTHK Archive'};
const selectProgram = {'tc':'選擇節目', 'sc':'选择节目', 'en':'Select Program'};
const selectDate = {'tc':'選擇日期', 'sc':'选择日期', 'en':'Select Date'};
const bookmarks = {'tc':'收藏節目', 'sc':'收藏节目', 'en':'Bookmarks'};
const tutorial = {'tc':'使用教學', 'sc':'使用教学', 'en':'Tutorial'};
const archive = {'tc':'節目重溫', 'sc':'节目重温', 'en':'Archive'};
const allContentAreFromInternet = {'tc':'此網站的內容均來自互聯網', 'sc':'此网站的内容均来自互联网', 'en':'Contents on this website are collected from the internet.'};
const selectDateOrEP = {'tc':'選擇日期/期數', 'sc':'选择日期/期数數', 'en':'Select Date Or Episodes'};
const loadMore7EP = {'tc':'載入更多(7期)', 'sc':'载入更多(7期)', 'en':'Load More(7 EPs)'};
const loadMore30EP = {'tc':'載入更多(30期)', 'sc':'载入更多(30期)', 'en':'Load More(30 EPs)'};
const download = {'tc':'下載', 'sc':'下载', 'en':'Download'};
...
'sc':'如有任何問題、或回報應用程式的錯誤，歡迎以電郵聯絡我：adorablesheepdev@gmail.com', 
'en':'If you have any questions or would like to report any bugs, please feel free to contact me at: adorablesheepdev@gmail.com'};
